...
if ((2 * pi * mod(net.t_out/period_1, 1)) > pi) & ((2 * pi * mod(net.t_out/period_1, 1)) < 3 * pi/2) & (net.FLAG_P_CHANGE == 1)
    ...
    if rand() < net.ENV_RENEWAL_RATE %1/3
        ...
        net.A1(1:1000) = net.mem_P{1}(1:1000);
        net.phi1(1:1000) = net.mem_P{2}(1:1000);
...
net.I{1} =  1 + net.A1 .* (cos(2 * pi * net.t_out / period_1 + net.phi1));
...
net.I{2} =  1 + net.A2 .* (cos(2 * pi * net.t_out / period_1 + net.phi2));
